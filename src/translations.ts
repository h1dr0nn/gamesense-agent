...
export const translations = {
    en: {
        ...
        about: 'About',
        aboutDesc: 'GameSense Agent is a modern tool for managing Android devices.',
    ...
    vi: {
        ...
        about: 'Giới thiệu',
        aboutDesc: 'GameSense Agent là công cụ hiện đại để quản lý thiết bị Android.',
